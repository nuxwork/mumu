...
public class FlowLayout extends ViewGroup {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        TypedArray a = context.obtainStyledAttributes(attributeSet, chat.mumu.lego.R.styleable.FlowLayout);
        try {
            this.horizontalSpacing = a.getDimensionPixelSize(chat.mumu.lego.R.styleable.FlowLayout_horizontalSpacing, 0);
            this.verticalSpacing = a.getDimensionPixelSize(chat.mumu.lego.R.styleable.FlowLayout_verticalSpacing, 0);
            this.orientation = a.getInteger(chat.mumu.lego.R.styleable.FlowLayout_orientation, HORIZONTAL);
            this.debugDraw = a.getBoolean(chat.mumu.lego.R.styleable.FlowLayout_debugDraw, false);
            this.weightSum = a.getFloat(chat.mumu.lego.R.styleable.FlowLayout_weightSum, 0.0f);
            this.weightDefault = a.getFloat(chat.mumu.lego.R.styleable.FlowLayout_weightDefault, 0.0f);
            this.centerJustified = a.getBoolean(chat.mumu.lego.R.styleable.FlowLayout_centerJustified, false);

            int gravityIndex = a.getInt(chat.mumu.lego.R.styleable.FlowLayout_android_gravity, -1);
            if (gravityIndex >= 0) {
                setGravity(gravityIndex);
            }
            int fillLinesIndex = a.getInt(chat.mumu.lego.R.styleable.FlowLayout_fillLines, -1);
            if (fillLinesIndex >= 0) {
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        private void readStyleParameters(Context context, AttributeSet attributeSet) {
            TypedArray a = context.obtainStyledAttributes(attributeSet, chat.mumu.lego.R.styleable.FlowLayout_LayoutParams);
            try {
                this.horizontalSpacing = a.getDimensionPixelSize(chat.mumu.lego.R.styleable.FlowLayout_LayoutParams_layout_horizontalSpacing, NO_SPACING);
                this.verticalSpacing = a.getDimensionPixelSize(chat.mumu.lego.R.styleable.FlowLayout_LayoutParams_layout_verticalSpacing, NO_SPACING);
                this.newLine = a.getBoolean(chat.mumu.lego.R.styleable.FlowLayout_LayoutParams_layout_newLine, false);
                this.gravity = a.getInt(chat.mumu.lego.R.styleable.FlowLayout_LayoutParams_android_layout_gravity, gravity);
                this.weight = a.getFloat(chat.mumu.lego.R.styleable.FlowLayout_LayoutParams_layout_weight, weight);
                this.centerJustified = a.getBoolean(chat.mumu.lego.R.styleable.FlowLayout_LayoutParams_layout_centerJustified, false);
            } finally {
                a.recycle();
            }
        }
